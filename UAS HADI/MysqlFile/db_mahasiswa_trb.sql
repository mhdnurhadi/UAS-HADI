...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Des 2023 pada 16.32
...
--
-- Database: `db_mahasiswa_trb`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `data_mhs_trb`
--

CREATE TABLE `data_mhs_trb` (
  `id` int(11) NOT NULL,
  ...
  `prodi` enum('Tadris matematika','Tadris fisika','Tardis biologi','PIAUD','PAI') NOT NULL,
  `status` enum('Aktif','Tidak aktif') NOT NULL,
  `gambar` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `data_mhs_trb`
--

INSERT INTO `data_mhs_trb` (`id`, `nama`, `nim`, `alamat`, `email`, `tanggal_lahir`, `jenis_kelamin`, `telepon`, `prodi`, `status`, `gambar`) VALUES
(5, 'Gusvika kurnia', '7011398393', 'jambi', 'vika@gmail.com', '1001-11-11', 'Perempuan', '92922929', '', 'Aktif', '65775184a52b9.jpg');
...
--
-- Indeks untuk tabel `data_mhs_trb`
--
ALTER TABLE `data_mhs_trb`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `data_mhs_trb`
--
ALTER TABLE `data_mhs_trb`
